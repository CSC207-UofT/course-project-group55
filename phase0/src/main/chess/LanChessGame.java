...
/*
public class LanChessGame extends ChessGame {
    Client client;


    public LanChessGame(int port, String[] playerNames){
        super(playerNames);
        try{
            client = new Client(port, playerNames);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public LanChessGame(String[] playerNames, String FEN){
       super(playerNames, FEN);
    }
